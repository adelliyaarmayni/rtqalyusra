        ...
        <div id="kehadiranTableContainer">
            <table>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $dataKehadiran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($loop->iteration + ($dataKehadiran->currentPage() - 1) * $dataKehadiran->perPage()); ?></td>
            ...
            <?php if($dataKehadiran->total() > 0): ?>
                <div class="pagination">
                    Showing <?php echo e($dataKehadiran->firstItem()); ?> to <?php echo e($dataKehadiran->lastItem()); ?> of <?php echo e($dataKehadiran->total()); ?> entries
                </div>
            <?php endif; ?>
...
</html><?php /**PATH D:\Adel\Semester 8\TA Adel\Sistem\sistemrtq\resources\views/admin/kehadiranA/detail.blade.php ENDPATH**/ ?>