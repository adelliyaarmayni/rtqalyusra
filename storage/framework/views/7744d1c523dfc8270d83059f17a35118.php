    ...
    <div class="main flex-1">
      <div class="gy-topbar bg-white flex justify-between items-center p-4 shadow">
        <div class="flex items-center gap-4">
          ...
          <p>Session Periode Aktif: <?php echo e(session('periode_aktif_guru')); ?></p>
        </div>
...
</html><?php /**PATH C:\laragon\www\Sistem\sistemrtq\resources\views/guru/dashboard/master.blade.php ENDPATH**/ ?>