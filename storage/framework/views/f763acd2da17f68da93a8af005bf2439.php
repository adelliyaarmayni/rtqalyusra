    ...
    <div class="main flex-1">
      <div class="gy-topbar bg-white flex justify-between items-center p-4 shadow flex-nowrap gap-4">
        ...
        <div class="flex-shrink-0">
          <img src="<?php echo e(asset('img/image/logortq.png')); ?>" alt="Logo" class="h-14 p-1 rounded bg-white" />
        </div>
      </div>
      ...
      <div class="chart-container p-4">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-4">
          ...
          <!-- Dropdown Periode -->
          <form id="periodeForm" method="GET" action="<?php echo e(route('yayasan.kehadiranY.detail', ['cabang' => $cabang])); ?>"
            class="relative">
            ...
            <button type="button" onclick="toggleDropdown()"
              ...
              <img src="<?php echo e(asset('img/image/arrowdown.png')); ?>" alt="arrow" class="w-4 h-4">
            </button>
