...
<body>
  ...
  <div class="container">
    ...
    <?php endif; ?>
      ...
      <form method="GET" action="<?php echo e(route('admin.jadwalmengajar.index')); ?>" id="filterForm" class="table-controls" style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 10px; align-items: center;">
        <div>
          Show
...
<?php /**PATH C:\laragon\www\Sistem\sistemrtq\resources\views/admin/jadwalmengajar/index.blade.php ENDPATH**/ ?>